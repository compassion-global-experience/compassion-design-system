...
<Canvas withSource="open">
  <Story id="components-icon--icon-props" />
</Canvas>
...
<Canvas withSource="open">
  <Story id="components-icon--icon-color" />
</Canvas>
...
<Canvas withSource="open">
  <Story id="components-icon--meaningful-icon" />
</Canvas>
...
<Canvas withSource="open">
  <Story id="components-icon--inline-icon" />
</Canvas>
...
<Canvas withSource="open">
  <Story id="components-icon--action-icon" />
</Canvas>
