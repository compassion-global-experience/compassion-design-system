...
To install the React components to your project, run either `npm i -D @compassion-gds/react-web`
or `yarn i @compassion-gds/react-web`, depending on which package manager your
project uses.

#### Importing a React Component

Each component exists as a named export within the `@compassion-gds/react-web`
package:
...
This Storybook instance has documentation on how to configure each component
once it’s been imported.
...
Include the CDS web components in your bundle, then include your bundle on your
site:
...
Browse the Storybook documentation to learn how the different components
work and how they can be configured!
...
nothing can stand against us. Check out the [Contributing: For Developers](/docs/contributing-for-developers--page)
