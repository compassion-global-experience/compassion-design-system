...
var Button = React.forwardRef(function (props, ref) {
    var label = props.label, _a = props.mode, mode = _a === void 0 ? 'primary' : _a, _b = props.size, size = _b === void 0 ? 'medium' : _b, _c = props.disabled, disabled = _c === void 0 ? false : _c, className = props.className, style = props.style, onClick = props.onClick, children = props.children, rest = __rest(props, ["label", "mode", "size", "disabled", "className", "style", "onClick", "children"]);
    var classNames = getClasses(styles$5, ['button-main', mode, size], className);
    return (jsxRuntime.jsx("button", __assign({ onClick: onClick, className: classNames, disabled: disabled, style: style, ref: ref }, rest, { children: children || label })));
});
...
var Modal = React.forwardRef(function (props, ref) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: wrapperClass, style: style, ref: ref }, rest, { children: [onClose && jsxRuntime.jsx(ModalClose, { onClick: onClose }), title && (jsxRuntime.jsx("div", __assign({ className: getClasses(styles$4, 'modal-header') }, { children: title }))), jsxRuntime.jsx("div", __assign({ className: bodyClass }, { children: children })), Boolean(footerSlot) && (jsxRuntime.jsx("div", __assign({ className: getClasses(styles$4, 'modal-footer') }, { children: footerSlot })))] })));
});
Modal.displayName = 'Modal';
var ModalClose = function (_a) {
    var onClick = _a.onClick;
    return (jsxRuntime.jsx("button", __assign({ type: "button", className: getClasses(styles$4, 'modal-button-close'), onClick: onClick }, { children: jsxRuntime.jsx(X$1, { size: 24 }) })));
};
...
var FieldContainer = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: containerClassNames }, { children: [label && (jsxRuntime.jsx("label", __assign({ className: labelClassNames, htmlFor: id }, { children: label }))), children, hint && jsxRuntime.jsx("span", __assign({ className: helperClassNames }, { children: hint }))] })));
};
var InputGroupContainer = function (_a) {
    ...
    return (jsxRuntime.jsx(FieldContainer, __assign({ id: id, label: label, state: state, hint: hint, className: className }, { children: jsxRuntime.jsxs("div", __assign({ className: getClasses(styles$3, 'input-group') }, { children: [startPosition && (jsxRuntime.jsx(Adornment, { icon: adornmentIcon, text: adornmentText, size: size })), children, !startPosition && (jsxRuntime.jsx(Adornment, { icon: adornmentIcon, text: adornmentText, size: size }))] })) })));
};
var StateIcon = function (props) {
    ...
    if (!icon)
        return null;
    return (jsxRuntime.jsx("span", __assign({ className: getClasses(props.classes || common, 'form-icon') }, { children: icon })));
};
var Adornment = function (_a) {
    var icon = _a.icon, text = _a.text, size = _a.size;
    return (jsxRuntime.jsxs("div", __assign({ className: getClasses(styles$3, ['input-group-adornment', size]) }, { children: [icon || jsxRuntime.jsx(Info$1, { size: 22 }), text && jsxRuntime.jsx("span", { children: text })] })));
};
...
var TextField = React.forwardRef(function (props, ref) {
    ...
    return (jsxRuntime.jsx(FieldContainer, __assign({ id: id, label: label, state: state, hint: hint, className: className }, { children: jsxRuntime.jsx(Input, __assign({ ref: ref, id: id, state: state, className: fieldClassName }, rest)) })));
});
TextField.displayName = 'TextField';

var InputGroup = React.forwardRef(function (props, ref) {
    ...
    return (jsxRuntime.jsx(InputGroupContainer, __assign({ id: id, label: label, state: state, size: size, hint: hint, className: className, adornmentPosition: adornmentPosition, adornmentText: adornmentText, adornmentIcon: adornmentIcon }, { children: jsxRuntime.jsx(Input, __assign({ ref: ref, id: id, state: state, size: size, className: fieldClassName }, rest)) })));
});
...
var TextArea = React.forwardRef(function (props, ref) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: containerClassNames }, { children: [jsxRuntime.jsxs("div", __assign({ className: getClasses(common, 'form-label-wrap') }, { children: [label && (jsxRuntime.jsx("label", __assign({ className: labelClassNames, htmlFor: id }, { children: label }))), showCounter && maxLength > 0 && (jsxRuntime.jsxs("span", __assign({ className: helperClassNames }, { children: [count, " / ", maxLength] })))] })), jsxRuntime.jsxs("div", __assign({ className: fieldClassNames }, { children: [jsxRuntime.jsx("textarea", __assign({ id: id, ref: ref, disabled: state === 'disabled', className: getClasses(styles$2, 'form-input'), onChange: onChangeCallback, maxLength: maxLength }, rest)), jsxRuntime.jsx(StateIcon, { state: state, size: size, classes: styles$2 })] }))] })));
});
...
var Select = React.forwardRef(function (props, ref) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: fieldClassNames }, { children: [jsxRuntime.jsxs("select", __assign({ ref: ref, id: id, className: getClasses(common, 'form-input'), disabled: state === 'disabled' }, rest, { children: [defaultOption && (jsxRuntime.jsx("option", __assign({ value: "select-option", disabled: true }, { children: defaultOption }))), options.map(function (_a, i) {
                        var value = _a.value, label = _a.label;
                        return (jsxRuntime.jsx("option", __assign({ value: value }, { children: label }), i));
                    })] })), icon && jsxRuntime.jsx("span", __assign({ className: getClasses(common, 'form-icon') }, { children: icon })), jsxRuntime.jsx(StateIcon, { state: state, size: size }), jsxRuntime.jsx("span", __assign({ className: getClasses(common, ['form-icon', 'select-icon']) }, { children: jsxRuntime.jsx(CaretDown$1, {}) }))] })));
});
Select.displayName = 'Select';

var SelectField = React.forwardRef(function (props, ref) {
    var id = props.id, _a = props.label, label = _a === void 0 ? '' : _a, state = props.state, _b = props.hint, hint = _b === void 0 ? '' : _b, className = props.className, fieldClassName = props.fieldClassName, rest = __rest(props, ["id", "label", "state", "hint", "className", "fieldClassName"]);
    return (jsxRuntime.jsx(FieldContainer, __assign({ id: id, label: label, state: state, hint: hint, className: className }, { children: jsxRuntime.jsx(Select, __assign({ ref: ref, id: id, className: fieldClassName, state: state }, rest)) })));
});
SelectField.displayName = 'SelectField';

var SelectGroup = React.forwardRef(function (props, ref) {
    var id = props.id, _a = props.label, label = _a === void 0 ? '' : _a, state = props.state, size = props.size, _b = props.hint, hint = _b === void 0 ? '' : _b, _c = props.adornmentPosition, adornmentPosition = _c === void 0 ? 'end' : _c, _d = props.adornmentText, adornmentText = _d === void 0 ? '' : _d, adornmentIcon = props.adornmentIcon, className = props.className, fieldClassName = props.fieldClassName, rest = __rest(props, ["id", "label", "state", "size", "hint", "adornmentPosition", "adornmentText", "adornmentIcon", "className", "fieldClassName"]);
    return (jsxRuntime.jsx(InputGroupContainer, __assign({ id: id, label: label, state: state, size: size, hint: hint, className: className, adornmentPosition: adornmentPosition, adornmentText: adornmentText, adornmentIcon: adornmentIcon }, { children: jsxRuntime.jsx(Select, __assign({ ref: ref, id: id, state: state, size: size, className: fieldClassName }, rest)) })));
});
...
var ChoiceInput = React.forwardRef(function (props, ref) {
    ...
    var helperClassNames = getClasses(common, 'form-hint', state);
    return (jsxRuntime.jsxs("div", __assign({ className: containerClassNames }, { children: [jsxRuntime.jsxs("div", __assign({ className: getClasses(styles$1, 'form-control') }, { children: [jsxRuntime.jsxs("div", __assign({ className: getClasses(styles$1, 'form-control-inner') }, { children: [jsxRuntime.jsx("input", __assign({ ref: ref, id: id, type: type, disabled: state === 'disabled', className: getClasses(styles$1, state) }, rest)), type === 'checkbox' && (jsxRuntime.jsx("span", __assign({ className: getClasses(styles$1, 'form-control-icon') }, { children: jsxRuntime.jsx(Check$1, {}) })))] })), jsxRuntime.jsx("label", __assign({ htmlFor: id, className: labelClassNames }, { children: label }))] })), hint && jsxRuntime.jsx("span", __assign({ className: helperClassNames }, { children: hint }))] })));
});
...
var PinField = function (_a) {
    ...
    return (jsxRuntime.jsxs("div", __assign({ className: getClasses(common, 'form-field-row') }, { children: [label && jsxRuntime.jsx("label", __assign({ className: labelClassNames }, { children: label })), jsxRuntime.jsx("div", __assign({ className: containerClassNames }, { children: fields.map(function (fieldProps, index) { return (jsxRuntime.jsx("div", __assign({ className: fieldClassNames }, { children: jsxRuntime.jsx("input", __assign({ className: getClasses(styles, 'form-input') }, fieldProps)) }), index)); }) }))] })));
};
...
var usePinHook = function (_a) {
    ...
    var fieldRefs = React.useRef(Array(values.length).fill(null));
    var setFocus = React.useCallback(function (index) {
        var _a;
    ...
    var setFieldRef = React.useCallback(function (index) { return function (ref) {
        fieldRefs.current[index] = ref;
    }; }, []);
    var onChange = React.useCallback(function (index) { return function (event) {
    ...
    var onKeyDown = React.useCallback(function (index) { return function (event) {
