...
import React, { forwardRef, memo, createContext, useContext, useState, useCallback, useRef, useEffect } from 'react';
...
const Button = forwardRef((props, ref) => {
    ...
    return (jsx("button", Object.assign({ onClick: onClick, className: classNames, disabled: disabled, style: style, ref: ref }, rest, { children: children || label })));
});
...
const Icon = memo(({ icon: IconComponent, size, color, className, mode, style }) => {
    const flavorClass = getClasses(styles$4, mode, className);
    console.log('flavorClass: ', flavorClass);
    return (jsx("span", Object.assign({ className: `${styles$4.icon} ${buttonStyles.icon} ${common.formIcon} ${styles$5.formControlIcon} ${flavorClass}`, style: Object.assign(Object.assign({}, style), { fontSize: size, color }) }, { children: jsx(IconComponent, {}) })));
});
...
const Modal = forwardRef((props, ref) => {
    ...
    return (jsxs("div", Object.assign({ className: wrapperClass, style: style, ref: ref }, rest, { children: [onClose && jsx(ModalClose, { onClick: onClose }), title && (jsx("div", Object.assign({ className: getClasses(styles$6, 'modal-header') }, { children: title }))), jsx("div", Object.assign({ className: bodyClass }, { children: children })), Boolean(footerSlot) && (jsx("div", Object.assign({ className: getClasses(styles$6, 'modal-footer') }, { children: footerSlot })))] })));
});
Modal.displayName = 'Modal';
const ModalClose = ({ onClick }) => (jsx("button", Object.assign({ type: "button", className: getClasses(styles$6, 'modal-button-close'), onClick: onClick }, { children: jsx(X$1, { size: 24 }) })));
...
const FieldContainer = ({ id, label = '', state, hint = '', className, children, }) => {
    ...
    return (jsxs("div", Object.assign({ className: containerClassNames }, { children: [label && (jsx("label", Object.assign({ className: labelClassNames, htmlFor: id }, { children: label }))), children, hint && jsx("span", Object.assign({ className: helperClassNames }, { children: hint }))] })));
};
const InputGroupContainer = ({ id, label = '', state, hint = '', adornmentPosition = 'end', adornmentText = '', adornmentIcon, className, size, children, }) => {
    ...
    return (jsx(FieldContainer, Object.assign({ id: id, label: label, state: state, hint: hint, className: className }, { children: jsxs("div", Object.assign({ className: getClasses(styles$3, 'input-group') }, { children: [startPosition && (jsx(Adornment, { icon: adornmentIcon, text: adornmentText, size: size })), children, !startPosition && (jsx(Adornment, { icon: adornmentIcon, text: adornmentText, size: size }))] })) })));
};
const StateIcon = (props) => {
    ...
    if (!icon)
        return null;
    return (jsx("span", Object.assign({ className: getClasses(props.classes || common, 'form-icon') }, { children: icon })));
};
const Adornment = ({ icon, text, size, }) => (jsxs("div", Object.assign({ className: getClasses(styles$3, ['input-group-adornment', size]) }, { children: [icon || jsx(Info$1, { size: 22 }), text && jsx("span", { children: text })] })));
...
const TextField = forwardRef((props, ref) => {
    ...
    return (jsx(FieldContainer, Object.assign({ id: id, label: label, state: state, hint: hint, className: className }, { children: jsx(Input, Object.assign({ ref: ref, id: id, state: state, className: fieldClassName }, rest)) })));
});
...
const TextArea = forwardRef((props, ref) => {
    ...
    return (jsxs("div", Object.assign({ className: containerClassNames }, { children: [jsxs("div", Object.assign({ className: getClasses(common, 'form-label-wrap') }, { children: [label && (jsx("label", Object.assign({ className: labelClassNames, htmlFor: id }, { children: label }))), showCounter && maxLength && (jsxs("span", Object.assign({ className: helperClassNames }, { children: [count, " / ", maxLength] })))] })), jsxs("div", Object.assign({ className: fieldClassNames }, { children: [jsx("textarea", Object.assign({ id: id, ref: ref, disabled: state === 'disabled', className: getClasses(styles$2, 'form-input'), onChange: onChangeCallback, maxLength: maxLength }, rest)), jsx(StateIcon, { state: state, size: size, classes: styles$2 })] }))] })));
});
...
const Select = forwardRef((props, ref) => {
    ...
    return (jsxs("div", Object.assign({ className: fieldClassNames }, { children: [jsxs("select", Object.assign({ ref: ref, id: id, className: getClasses(common, 'form-input'), disabled: state === 'disabled' }, rest, { children: [defaultOption && (jsx("option", Object.assign({ value: "select-option", disabled: true }, { children: defaultOption }))), options.map(({ value, label }, i) => (jsx("option", Object.assign({ value: value }, { children: label }), i)))] })), icon && jsx("span", Object.assign({ className: getClasses(common, 'form-icon') }, { children: icon })), jsx(StateIcon, { state: state, size: size }), jsx("span", Object.assign({ className: getClasses(common, ['form-icon', 'select-icon']) }, { children: jsx(CaretDown$1, {}) }))] })));
});
Select.displayName = 'Select';

const SelectField = forwardRef((props, ref) => {
    const { id, label = '', state, hint = '', className, fieldClassName } = props, rest = __rest(props, ["id", "label", "state", "hint", "className", "fieldClassName"]);
    return (jsx(FieldContainer, Object.assign({ id: id, label: label, state: state, hint: hint, className: className }, { children: jsx(Select, Object.assign({ ref: ref, id: id, className: fieldClassName, state: state }, rest)) })));
});
...
const ChoiceInput = forwardRef((props, ref) => {
    ...
    const helperClassNames = getClasses(common, 'form-hint', state);
    return (jsxs("div", Object.assign({ className: containerClassNames }, { children: [jsxs("div", Object.assign({ className: getClasses(styles$5, 'form-control') }, { children: [jsxs("div", Object.assign({ className: getClasses(styles$5, 'form-control-inner') }, { children: [jsx("input", Object.assign({ ref: ref, id: id, type: type, disabled: state === 'disabled', className: getClasses(styles$5, state) }, rest)), type === 'checkbox' && (jsx("span", Object.assign({ className: getClasses(styles$5, 'form-control-icon') }, { children: jsx(Check$1, {}) })))] })), jsx("label", Object.assign({ htmlFor: id, className: labelClassNames }, { children: label }))] })), hint && jsx("span", Object.assign({ className: helperClassNames }, { children: hint }))] })));
});
...
const PinField = ({ label, value, length = 4, state, size, secret = false, autoFocus = false, pattern = DEFAULT_PATTERN, className, onComplete, }) => {
    ...
    const labelClassNames = getClasses(common, ['form-label', state]);
    const [values, setValues] = useState(() => Array.from({ length }).map((_, i) => (value === null || value === void 0 ? void 0 : value.toString()[i]) || ''));
    ...
    return (jsxs("div", Object.assign({ className: getClasses(common, 'form-field-row') }, { children: [label && jsx("label", Object.assign({ className: labelClassNames }, { children: label })), jsx("div", Object.assign({ className: containerClassNames }, { children: fields.map((fieldProps, index) => (jsx("div", Object.assign({ className: fieldClassNames }, { children: jsx("input", Object.assign({ className: getClasses(styles$1, 'form-input') }, fieldProps)) }), index))) }))] })));
};
...
const usePinHook = ({ values, autoFocus, secret, state, pattern, onChange: onChangeProp, onComplete, }) => {
    ...
    const fieldRefs = useRef(Array(values.length).fill(null));
    ...
    const setFieldRef = useCallback((index) => (ref) => {
        fieldRefs.current[index] = ref;
    }, []);
    const onChange = useCallback((index) => (event) => {
...
function Table(props) {
    ...
    return (jsx("div", Object.assign({ className: containerClassNames, style: containerStyle }, { children: jsxs("table", Object.assign({ ref: forwardedRef, className: classNames, style: tableStyle }, { children: [jsx("thead", Object.assign({ className: headClass }, { children: jsx("tr", Object.assign({ className: rowClass }, { children: columns.map((col) => (jsx("th", Object.assign({ className: getClasses(styles, [
                                'table-cell',
                                col.disabled ? 'disabled' : undefined,
                            ]) }, { children: col.headerRender ? col.headerRender(col) : col.title }), col.key))) })) })), jsx("tbody", Object.assign({ className: bodyClass }, { children: rows.map((row, rowIndex) => (jsx("tr", Object.assign({ className: getClasses(styles, [
                            'table-row',
                            row.disabled && 'disabled',
                        ]) }, { children: columns.map((col) => (jsx("td", Object.assign({ className: getClasses(styles, [
                                'table-cell',
...
const TableWithRef = (props, ref) => jsx(Table, Object.assign({}, props, { forwardedRef: ref }));
TableWithRef.displayName = 'Table';
var Table$1 = forwardRef(TableWithRef);

export { Button, ChoiceInput, Icon, Input, InputGroup, Modal, PinField, Select, SelectField, SelectGroup, Table$1 as Table, TextArea, TextField };
